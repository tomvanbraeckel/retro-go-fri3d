...
void app_main(void)
{
    ...
    // If this was started from MicroPython (OTA_0 or OTA_1) on the Fri3D Camp badge,
    // then save the rollback partition for when the times comes to go back to MicroPython.
